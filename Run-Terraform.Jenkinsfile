        ...
        success {
            ...
            script {
                if (params.Destroy == false && params.Build_Gocitizen == true) {
                    build job: 'GitHub-Geocitizen-Build', parameters: [string(name: 'WEB_IP', value: String.valueOf(env.WEB_IP)), string(name: 'DB_IP', value: String.valueOf(env.DB_IP))], wait: false
                }
            }
        }
        failure{
